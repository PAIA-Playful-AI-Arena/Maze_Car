...
class MazeCar(PaiaGame):
    ...
    def get_scene_progress_data(self) -> dict:
        ...
        game_progress["background"].append(create_text_view_data("frames", 815, 100, WHITE, font_style="20px Arial"))
